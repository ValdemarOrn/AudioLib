...
namespace AudioLib.Test
{
	...
	class MidiTest
	{
		...
		{
			var m = new Midi(new byte[3] { 0x8F, 56, 127 });
		...
		{
			var m = new Midi(new byte[3] { 0x95, 56, 0 });
		...
		{
			var m = new Midi(new byte[3] { 0xA6, 56, 23 });
		...
		{
			var m = new Midi(new byte[3] { 0xB0, 42, 125 });
		...
		{
			var m = new Midi(new byte[2] { 0xC1, 23 });
		...
		{
			var m = new Midi(new byte[2] { 0xD1, 99 });
			Assert.AreEqual(1, m.Channel);
		...
		{
			var m = new Midi(new byte[3] { 0xEB, 126, 42 });
